...
// 1. Init common functions on document ready
    ...
    $(function() {
        ...
        unibox_page_onload.init();

        // main header
        unibox_main_header.init();

        // main sidebar
        unibox_main_sidebar.init();
        // secondary sidebar
        unibox_secondary_sidebar.init();

        // top bar
        unibox_top_bar.init();

        // page heading
        unibox_page_heading.init();
        ...
        unibox_helpers.truncate_text($('.truncate-text'));

        // full screen
        unibox_helpers.full_screen();

        // table check
        unibox_helpers.table_check();

        // print page
        unibox_helpers.print_page();
...
// 3. Common functions & variables
    ...
    unibox_page_onload = {
        init: function() {
            $window.on('load',function(){
                ...
                unibox_helpers.hierarchical_show();
                unibox_helpers.hierarchical_slide();
            });
        }
    };
    ...
    unibox_forms = {
        init: function() {
            ...
            unibox_forms.select_elements();
            unibox_forms.switches();
            unibox_forms.dynamic_fields();
        },
        ...
        dynamic_fields: function() {
            ...
            $('.btnSectionClone').on('click', function(e) {
                ...
                var $this = $(this),
                    ...
                    cloned_section
                        ...
                        .find('.md-input').each(function(index) {
                            ...
                            unibox_md.update_input($thisInput);
                        })
                        .end()
                        ...
                        .find('[data-md-selectize]').each(function(index) {
                            ...
                            if(selectize) {
                                ...
                                unibox_forms.select_elements(orgSelect.parent());
                ...
                unibox_md.checkbox_radio($newSection.find('[data-md-icheck]'));
                // reinitialize switches
                unibox_forms.switches($newSection);
                // reinitialize selectize
                unibox_forms.select_elements($newSection);
        ...
        init: function() {
            if($sidebar_main.length) {
                ...
                if(lsTest()) {
                    ...
                    if(localStorage.getItem("unibox_sidebar_mini") !== null) {
                        $body.addClass('sidebar_mini');
                    }
                    if(localStorage.getItem("unibox_sidebar_slim") !== null) {
                ...
                if ($body.hasClass('sidebar_mini')) {
                    ...
                    // small sidebar
                    unibox_main_sidebar.mini_sidebar();
                    ...
                    // slim sidebar
                    unibox_main_sidebar.slim_sidebar();

                    // custom scroller
                    unibox_helpers.custom_scrollbar($sidebar_main);

                    // menu
                    unibox_main_sidebar.sidebar_menu();
                    ...
                    $sidebar_main_toggle.on('click', function(e) {
                        e.preventDefault();
                        ( $body.hasClass('sidebar_main_active') || ($body.hasClass('sidebar_main_open') && $window.width() >= 1220) ) ? unibox_main_sidebar.hide_sidebar() : unibox_main_sidebar.show_sidebar();
                    });
                    ...
                    $document.on('click keyup', function(e) {
                        if( $body.hasClass('sidebar_main_active') && $window.width() < 1220 ) {
                            if (
                                ...
                                unibox_main_sidebar.hide_sidebar();
                            }
                        }
                    });
                    ...
                    if( $body.hasClass('sidebar_main_active') && $window.width() < 1220 ) {
                        unibox_page_content.hide_content_sidebar();
                    } else {
                        unibox_page_content.show_content_sidebar();
                    }
                    ...
                    unibox_main_sidebar.swipe_open();

                }

                // language switcher
                unibox_main_sidebar.lang_switcher();
            }
        },
            ...
            if( $body.hasClass('sidebar_main_swipe') && Modernizr.touch) {
                ...
                mc.on("swiperight", function() {
                    if (!$body.hasClass('sidebar_main_active')) {
                        unibox_main_sidebar.show_sidebar();
                    }
                });
        ...
        init: function() {
            if($sidebar_secondary.length) {
                ...
                $sidebar_secondary_toggle.on('click', function (e) {
                    e.preventDefault();
                    $body.hasClass('sidebar_secondary_active') ? unibox_secondary_sidebar.hide_sidebar() : unibox_secondary_sidebar.show_sidebar();
                });
                ...
                $document.on('click keydown', function(e) {
                    ...
                    if( $body.hasClass('sidebar_secondary_active') && ( ( !$(e.target).closest($sidebar_secondary).length && !$(e.target).closest($sidebar_secondary_toggle).length ) || (e.which == 27) )) {
                        unibox_secondary_sidebar.hide_sidebar();
                    }
                });
                ...
                // custom scroller
                unibox_helpers.custom_scrollbar($sidebar_secondary);

                // chat section
                unibox_secondary_sidebar.chat_sidebar();
    ...
    unibox_main_header = {
        init: function() {
            unibox_main_header.search_activate();
            unibox_main_header.search_autocomplete();
        },
        search_activate: function() {

            $('#main_search_btn').on('click',function(e) {
                e.preventDefault();
                unibox_main_header.search_show();
            });
            ...
            $(document).on('click keydown', function(e) {
                if( !$body.hasClass('main_search_persistent') && $body.hasClass('main_search_active') ) {
                    if (
                        ...
                        unibox_main_header.search_hide();
                    }
                }
            });
    ...
    unibox_md = {
        init: function() {
            ...
            unibox_md.card_fullscreen();
            unibox_md.card_expand();
            unibox_md.card_overlay();
            unibox_md.card_single();
            unibox_md.card_panel();
            unibox_md.card_progress();
            unibox_md.list_outside();
            // FAB transitions
            unibox_md.fab_speed_dial();
            unibox_md.fab_toolbar();
            unibox_md.fab_sheet();
            unibox_md.wave_effect();
        },
        ...
        card_panel: function() {
            ...
            $('.md-card-close').on('click',function(e) {
                ...
                unibox_md.card_show_hide(thisCard,undefined,removeCard)
            });
        ...
        list_outside: function() {
            ...
            if($md_list_outside_wrapper && $body.hasClass('header_double_height')) {
                ...
                unibox_helpers.custom_scrollbar($md_list_outside_wrapper);
            }
        },
        ...
        color_picker: function(object,pallete,callback) {
            if(object) {
                var cp_id = randID_generator(),
                    ...
                    cp_wrapper = $('<div class="cp_unibox" id="'+cp_id+'"/>');
                ...
                $body.on('click', '#'+cp_id+' span',function() {
                    $(this)
                        ...
                        .end()
                        .closest('.cp_unibox').find('input').val($(this).attr('data-color'));
