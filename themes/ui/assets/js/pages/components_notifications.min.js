...
function showNotify(t) {
    if (thisNotify = UIkit.notify({
            message: t.data("message") ? t.data("message") : "",
            status: t.data("status") ? t.data("status") : "",
...
$(function () {
    ...
    init: function () {
        $body.on("click", "[data-message]", function () {
            var t = $(this);
            $body.find(".uk-notify-message").length ? ($body.find(".uk-notify-message").click(), setTimeout(function () {
                showNotify(t)
            }, 450)) : showNotify(t)
        })
    }
