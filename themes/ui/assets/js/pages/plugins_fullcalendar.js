$(function() {
    // fullcalendar
    unibox_fullcalendar.calendar_selectable();
});
unibox_fullcalendar = {
    calendar_selectable: function() {
        ...
        var calendarColorPicker = unibox_helpers.color_picker(calendarColorsWrapper).prop('outerHTML');
...
/*// calendar events
 ...
 // color picker
 unibox_helpers.color_picker($('#eUpdate_colors'));
 ...
 unibox_md.update_input($('#eUpdate_title,#eUpdate_start,#eUpdate_end'));
