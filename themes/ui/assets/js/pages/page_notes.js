$(function() {
    ...
    unibox_notes.copy_list_sidebar();
...
unibox_notes = {
    init: function () {
        unibox_notes.add_new_note();
        unibox_notes.open_note();
    },
    add_new_note: function() {
        if($note_add_btn) {
            ...
            $note_add_btn.on('click', function(e) {
                e.preventDefault();
                unibox_md.card_show_hide($card_note,undefined,clear_inputs,undefined)
            })
        }
    },
    open_note: function() {
        ...
        $(notes_list_class).find('a').on('click',function(e) {
            e.preventDefault();
            var $this_note = $(this);
            unibox_md.card_show_hide($card_note,undefined,fill_inputs,$this_note);
            $(this).closest('li')
