...
unibox_invoices  = {
    init: function() {
        ...
        unibox_invoices.copy_list_sidebar();
        // add new invoice
        unibox_invoices.add_new();
        // open invoice
        unibox_invoices.open_invoice();
        // print invoice btn
        unibox_invoices.print_invoice();
    },
    add_new: function() {
        if($invoice_add_btn) {
            ...
            $invoice_add_btn.on('click', function (e) {
                e.preventDefault();
                unibox_md.card_show_hide($invoice_card,insert_form,show_form,undefined);
            })
    ...
    open_invoice: function() {
        ...
        $(invoice_list_class)
            .on('click','a', function(e) {
                ...
                unibox_md.card_show_hide($invoice_card,undefined,show_invoice,$(this));
                // set active class
