...
unibox_code_editor = {
    init: function() {
        unibox_code_editor.copy_list_sidebar();

        unibox_code_editor.init_code_editor();
        unibox_code_editor.distraction_free_mode();
        unibox_code_editor.change_theme();
    },
    init_code_editor: function() {
        ...
        function loadFile(file,mode,callback) {
            // show preloader
            unibox_helpers.content_preloader_show('regular',$('.md-card-single'));
