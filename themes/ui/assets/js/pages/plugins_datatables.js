$(function() {
    // datatables
    unibox_datatables.dt_default();
    unibox_datatables.dt_scroll();
    unibox_datatables.dt_individual_search();
    unibox_datatables.dt_colVis();
    unibox_datatables.dt_tableExport();
});
