$(function() {
    // login_page
    unibox_login_page.init();
});

// variables
var $login_card = $('#login_card'),
    $active_card = $('#activate'),
...
unibox_login_page = {
    init: function () {
        ...
        $('#login_help_show').on('click',function(e) {
            ...
            unibox_md.card_show_hide($login_card,undefined,login_help_show,undefined);
        });
        ...
        $('#signup_form_show').on('click',function(e) {
            ...
            unibox_md.card_show_hide($login_card,undefined,register_form_show,undefined);
        });
        ...
        $('.back_to_login').on('click',function(e) {
            ...
            unibox_md.card_show_hide($login_card,undefined,login_form_show,undefined);
        });

        $('.password_reset_show').on('click',function(e) {
            e.preventDefault();
            unibox_md.card_show_hide($login_card,undefined,password_reset_show,undefined);
        });
