...
class HTML5TreeConstructer
{
    ...
    private function inCaption($token)
    {
        ...
        if($token['type'] === HTML5::ENDTAG && $token['name'] === 'caption') {
            ...
            /* Otherwise: */
                ...
                marker. */
                $this->clearTheFormattingElementsUpToTheLastMarker();
    ...
    private function reconstructFormattingElements()
    {
    ...
    private function clearTheFormattingElementsUpToTheLastMarker()
    {
