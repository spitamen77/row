...
/* @var $manifest array */
/* @var $searchModel \uni\debug\models\search\Debug */
/* @var $dataProvider ArrayDataProvider */
/* @var $panels \uni\debug\Panel[] */

use uni\helpers\Html;
use uni\grid\GridView;
    ...
    echo GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'time',
                'value' => function ($data) {
                    return '<span class="nowrap">' . Uni::$app->formatter->asDatetime($data['time'], 'yyyy-MM-dd HH:mm:ss') . '</span>';
                },
                'format' => 'html',
            ],
            'ip',
