 ...
 * or [[\uni\widgets\Menu]] to build up such content. For example,
 *
 * ```php
 * use uni\bootstrap\NavBar;
 * use uni\bootstrap\Nav;
 *
...
class NavBar extends Widget
{
    ...
    /**
     * @var array|string|boolean $url the URL for the brand's hyperlink tag. This parameter will be processed by [[\uni\helpers\Url::to()]]
     * and will be used for the "href" attribute of the brand link. Default value is false that means
     * [[\uni\web\Application::homeUrl]] will be used.
    ...
    public function init()
    {
        ...
        if ($this->brandLabel !== false) {
            ...
            echo Html::a($this->brandLabel, $this->brandUrl === false ? Uni::$app->homeUrl : $this->brandUrl, $this->brandOptions);
        }
