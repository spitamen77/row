...
namespace uni\generator\generators\controller;
 ...
 * read-only.
 * @property \uni\base\Module $module The module that the new controller belongs to. This property is
 * read-only.
 *
...
class Generator extends \uni\generator\Generator
{
     ...
     */
    public $baseClass = 'uni\web\Controller';
    /**
    ...
    {
        parent::init();
        $this->ns = \Uni::$app->controllerNamespace;
    }
    ...
    public function successMessage()
    {
        ...
        $link = Html::a('try it now', Uni::$app->getUrlManager()->createUrl($route), ['target' => '_blank']);
    ...
    /**
     * @return \uni\base\Module the module that the new controller belongs to
     */
    public function getModule()
    {
        if (($pos = strrpos($this->controller, '/')) !== false) {
            $id = substr($this->controller, 0, $pos);
            if (($module = Uni::$app->getModule($id)) !== null) {
                return $module;
            }
        }
