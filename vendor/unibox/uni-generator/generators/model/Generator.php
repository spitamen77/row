...
namespace uni\generator\generators\model;
...
class Generator extends \uni\generator\Generator
{
    ...
    public $tableName;
    public $modelClass;
    public $baseClass = 'uni\db\ActiveRecord';
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $files[] = new CodeFile(
                Uni::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/' . $className . '.php',
     ...
     * @param  \uni\db\TableSchema $table the table schema
     ...
     * @param \uni\db\TableSchema the table being checked
    ...
    {
        if (!Uni::$app->has($this->db)) {
            $this->addError('db', 'There is no application component named "db".');
        } elseif (!Uni::$app->get($this->db) instanceof Connection) {
    ...
    public function validateNamespace()
    {
        ...
        $path = Uni::getAlias('@' . str_replace('\\', '/', $this->ns), false);
        if ($path === false) {
