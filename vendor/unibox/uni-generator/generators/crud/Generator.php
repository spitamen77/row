...
namespace uni\generator\generators\crud;
 ...
 * @property boolean|\uni\db\TableSchema $tableSchema This property is read-only.
...
class Generator extends \uni\generator\Generator
{
    ...
    public $baseControllerClass = 'uni\web\Controller';
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'baseControllerClass' => 'This is the class that the new CRUD controller class will extend from.
                You should provide a fully qualified class name, e.g., <code>uni\web\Controller</code>.',
    ...
    public function validateModuleID()
    {
        if (!empty($this->moduleID)) {
            $module = Uni::$app->getModule($this->moduleID);
            if ($module === null) {
    ...
    {
        $controllerFile = Uni::getAlias('@' . str_replace('\\', '/', ltrim($this->controllerClass, '\\')) . '.php');
        $searchModel = Uni::getAlias('@' . str_replace('\\', '/', ltrim($this->searchModelClass, '\\') . '.php'));
        $files = [
    ...
    {
        $module = empty($this->moduleID) ? Uni::$app : Uni::$app->getModule($this->moduleID);
     ...
     * @param  \uni\db\ColumnSchema $column
     * @return string
     */
     ...
     * @return boolean|\uni\db\TableSchema
     */
