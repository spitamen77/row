...
namespace uni\generator\generators\extension;
...
{
    public $vendorName;
    public $packageName = "uni-";
    public $namespace;
    public $type = "uni-extension";
    public $keywords = "uni,extension";
    public $title;
    public $description;
    ...
    {
        return 'This generator helps you to generate the files needed by a Uni extension.';
    }
    ...
    public function hints()
    {
        return [
            ...
            'packageName' => 'This is the name of the extension on packagist, eg. <code>uni-foobar</code>.',
            'namespace'   => 'PSR-4, eg. <code>myself\foobar\</code> This will be added to your autoloading by composer. Do not use uni or uni in the namespace.',
    ...
    {
        $outputPath = realpath(\Uni::getAlias($this->outputPath));
        $output1 = <<<EOD
...
EOD;
    ...
    {
        return Uni::getAlias($this->outputPath);
    }
