...
use uni\generator\components\DiffRendererHtmlInline;
...
class CodeFile extends BaseObject
{
    ...
    {
        $module = Uni::$app->controller->module;
    ...
    {
        if (strpos($this->path, Uni::$app->basePath) === 0) {
            return substr($this->path, strlen(Uni::$app->basePath) + 1);
        } else {
            return $this->path;
        }
    }
