 ...
 *
 * By default, [[\Uni::$container]] refers to a Container instance which is used by [[\Uni::createObject()]]
 ...
 * $container->set('uni\db\Connection', [
 *     'dsn' => '...',
 * ]);
...
class Container extends Component
{
     ...
     *
     * If the class implements [[\uni\base\Configurable]], the `$config` parameter will be passed as the last
     ...
     * $container->set('uni\mail\MailInterface', 'uni\swiftmailer\Mailer');
     *
     * // register an alias name. You can use $container->get('foo')
     * // to create an instance of Connection
     * $container->set('foo', 'uni\db\Connection');
     *
     ...
     *     return new \uni\db\Connection($config);
     * });
     * ```
     *
    ...
    protected function build($class, $params, $config)
    {
        ...
        if (!empty($dependencies) && $reflection->implementsInterface('uni\base\Configurable')) {
