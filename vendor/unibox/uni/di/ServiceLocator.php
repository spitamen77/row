 ...
 *
 * ```php
 * $locator = new \uni\di\ServiceLocator;
 ...
 * ```
 *
 * Because [[\uni\base\Module]] extends from ServiceLocator, modules and the application are all service locators.
 *
...
class ServiceLocator extends Component
{
    ...
    public function get($id, $throwException = true)
    {
        ...
        if (isset($this->_definitions[$id])) {
            ...
            if (is_object($definition) && !$definition instanceof Closure) {
                ...
                return $this->_components[$id] = Uni::createObject($definition);
            }
     ...
     * ```php
     * // a class name
     * $locator->set('cache', 'uni\caching\FileCache');
     *
     ...
     *     return new \uni\caching\FileCache;
     * });
     *
     * // an instance
     * $locator->set('cache', new \uni\caching\FileCache);
     * ```
     *
