...
<head>
    <meta charset="utf-8"/>
    <title>Uni Application Requirement Checker</title>
    <?php $this->renderViewFile(dirname(__FILE__) . '/css.php'); ?>
</head>
<body>
<div class="container">
    <div class="header">
        <h1>Uni Application Requirement Checker</h1>
    </div>
    <hr>
    ...
    <div class="content">
        ...
        to allow Uni to work as expected. There are also some optional requirements being checked which will
        show you a warning when they do not meet. You can use Uni framework without them but some specific
    ...
    <div class="footer">
        ...
        <p>Powered by <a href="http://www.uniframework.com/" rel="external">Uni Framework</a></p>
    </div>
</div>
</body>
</html>
