<?php
/**
 * These are the Uni core requirements for the [[UniRequirementChecker]] instance.
 * These requirements are mandatory for any Uni application.
 */

/* @var $this UniRequirementChecker */
return array(
    array(
        'name' => 'PHP version',
        'mandatory' => true,
        'condition' => version_compare(PHP_VERSION, '5.4.0', '>='),
        'by' => '<a href="http://www.uniframework.com">Uni Framework</a>',
    ...
    array(
        ...
        'by' => '<a href="http://www.uniframework.com/doc-2.0/uni-base-security.html">Security Component</a>',
    ...
    array(
        ...
        in <code>Uni::t()</code>, non-latin languages with <code>Inflector::slug()</code>,
        <abbr title="Internationalized domain names">IDN</abbr>-feature of
        <code>EmailValidator</code> or <code>UrlValidator</code> or the <code>uni\i18n\Formatter</code> class.'
    ),
    array(
        'name' => 'ICU version',
        'mandatory' => false,
        ...
        <a href=\"http://www.uniframework.com/doc-2.0/uni-i18n-formatter.html#asRelativeTime%28%29-detail\">
        Formatter::asRelativeTime()</a>) in the <code>uni\i18n\Formatter</code> class. Your current ICU version is ' .
    ...
    array(
        ...
        (for example, plural in
        <a href=\"http://www.uniframework.com/doc-2.0/uni-i18n-formatter.html#asRelativeTime%28%29-detail\">
        Formatter::asRelativeTime()</a>) in the <code>uni\i18n\Formatter</code> class. Your current ICU Data version is ' .
    ...
    array(
        ...
        'memo' => 'Required for REST API to send XML responses via <code>uni\web\XmlResponseFormatter</code>.'
    ),
);
