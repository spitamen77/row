...
/**
 * UniRequirementChecker allows checking, if current system meets the requirements for running the Uni application.
 * This class allows rendering of the check report for the web and console application interface.
 *
 * Example:
 *
 * ```php
 * require_once('path/to/UniRequirementChecker.php');
 * $requirementsChecker = new UniRequirementChecker();
 * $requirements = array(
 *     array(
 ...
 *     ),
 * );
 * $requirementsChecker->checkUni()->check($requirements)->render();
 * ```
 *
 ...
 * ```
 *
 * Note: this class definition does not match ordinary Uni style, because it should match PHP 4.3
...
class UniRequirementChecker
{
    ...
    /**
     * Performs the check for the Uni core requirements.
     * @return UniRequirementChecker self instance.
     */
    function checkUni()
    {
