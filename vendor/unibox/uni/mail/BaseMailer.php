...
use uni\base\ViewContextInterface;
use uni\web\View;
...
abstract class BaseMailer extends Component implements MailerInterface, ViewContextInterface
{
     ...
     */
    public $messageClass = 'uni\mail\BaseMessage';
    /**
    ...
    /**
     * @var \uni\base\View|array view instance or its array configuration.
     */
    private $_view = [];
    /**
    ...
    public function compose($view = null, array $params = [])
    {
        ...
        if (isset($text)) {
            ...
            $text = html_entity_decode(strip_tags($html), ENT_QUOTES | ENT_HTML5, Uni::$app ? Uni::$app->charset : 'UTF-8');
            // improve whitespace
    ...
    {
        $path = Uni::getAlias($this->fileTransportPath);
        if (!is_dir(($path))) {
