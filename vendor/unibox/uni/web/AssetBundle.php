...
class AssetBundle extends BaseObject
{
    ...
    public function init()
    {
        if ($this->sourcePath !== null) {
            $this->sourcePath = rtrim(Uni::getAlias($this->sourcePath), '/\\');
        }
        if ($this->basePath !== null) {
            $this->basePath = rtrim(Uni::getAlias($this->basePath), '/\\');
        }
     ...
     * @param \uni\web\View $view the view that the asset files are to be registered with.
     */
