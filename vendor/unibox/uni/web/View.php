 ...
 *
 * View is configured as an application component in [[\uni\base\Application]] by default.
 * You can access that instance via `Uni::$app->view`.
 *
 ...
 * ```
 *
 * @property \uni\web\AssetManager $assetManager The asset manager. Defaults to the "assetManager" application
 * component.
 *
 * @author Nuriddin Rashidov rnn0891@gmail.com
 * @since alfa version
 */
class View extends \uni\base\View
{
    /**
     ...
     */
    const PH_HEAD = '<![CDATA[UNI-BLOCK-HEAD]]>';
    /**
     * This is internally used as the placeholder for receiving the content registered for the beginning of the body section.
     */
    const PH_BODY_BEGIN = '<![CDATA[UNI-BLOCK-BODY-BEGIN]]>';
    /**
     * This is internally used as the placeholder for receiving the content registered for the end of the body section.
     */
    const PH_BODY_END = '<![CDATA[UNI-BLOCK-BODY-END]]>';
     ...
     * @return \uni\web\AssetManager the asset manager. Defaults to the "assetManager" application component.
     */
    public function getAssetManager()
    {
        return $this->_assetManager ?: Uni::$app->getAssetManager();
    }

    /**
     * Sets the asset manager.
     * @param \uni\web\AssetManager $value the asset manager
     */
