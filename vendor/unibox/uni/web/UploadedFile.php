...
class UploadedFile extends BaseObject
{
     ...
     * Instead, use [[\uni\helpers\FileHelper::getMimeType()]] to determine the exact MIME type.
     */
    public $type;
    /**
     ...
     * The file should be uploaded using [[\uni\widgets\Field::fileInput()]].
     * @param \uni\base\Model $model the data model
