 ...
 * [[page|current page]], etc. These information can be passed to [[\uni\widgets\LinkPager|pagers]]
...
class Pagination extends BaseObject implements Linkable
{
    ...
    public $params;
    /**
     * @var \uni\web\UrlManager the URL manager used for creating pagination URLs. If not set,
