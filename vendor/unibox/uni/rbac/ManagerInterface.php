...
interface ManagerInterface
{
     ...
     * @throws \uni\base\InvalidParamException if $permissionName does not refer to an existing permission
     */
     ...
     * @param string|integer $userId the user ID (see [[\uni\web\User::id]])
     ...
     * @param Item $parent
     * @param Item $child
     * @throws \uni\base\Exception if the parent-child relationship already exists or if a loop has been detected.
     */
     ...
     * @param mixed $userId the user ID (see [[\uni\web\User::id]])
     * @return boolean whether the revoking is successful
     */
