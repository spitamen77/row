...
class PhpManager extends BaseManager
{
    ...
    {
        parent::init();
        $this->itemFile = Uni::getAlias($this->itemFile);
        $this->assignmentFile = Uni::getAlias($this->assignmentFile);
        $this->ruleFile = Uni::getAlias($this->ruleFile);
        $this->load();
    }
    ...
    protected function checkAccessRecursive($user, $itemName, $params, $assignments)
    {
        ...
        Uni::trace($item instanceof Role ? "Checking role: $itemName" : "Checking permission : $itemName", __METHOD__);
