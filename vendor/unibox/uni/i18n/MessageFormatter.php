...
class MessageFormatter extends Component
{
    ...
    public function format($pattern, $params, $language)
    {
        ...
        // replace named arguments (https://github.com/unisoft/uni2/issues/9678)
     ...
     * @throws \uni\base\NotSupportedException when PHP intl extension is not installed.
     */
    ...
    {
        $charset = Uni::$app ? Uni::$app->charset : 'UTF-8';
        $depth = 1;
     ...
     * @throws \uni\base\NotSupportedException when unsupported formatting is used.
     */
