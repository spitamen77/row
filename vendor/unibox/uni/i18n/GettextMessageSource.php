...
class GettextMessageSource extends MessageSource
{
    ...
    protected function loadMessages($category, $language)
    {
        ...
        if ($fallbackLanguage !== $language) {
            ...
            if ($messages === null && $fallbackMessages === null && $fallbackLanguage !== $this->sourceLanguage) {
                Uni::error("The message file for category '$category' does not exist: $messageFile Fallback file does not exist as well: $fallbackMessageFile", __METHOD__);
            ...
            if ($messages === null) {
                Uni::error("The message file for category '$category' does not exist: $messageFile", __METHOD__);
            }
        }
    ...
    {
        $messageFile = Uni::getAlias($this->basePath) . '/' . $language . '/' . $this->catalog;
        if ($this->useMoFile) {
