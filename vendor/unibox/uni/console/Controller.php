 ...
 * The `uni` program is used when calling a console command, like the following:
 *
 * ```
...
class Controller extends \uni\base\Controller
{
        ...
        if (!empty($params)) {
            ...
            foreach ($params as $name => $value) {
                if (in_array($name, $options, true)) {
                    ...
                    throw new Exception(Uni::t('uni', 'Unknown option: --{name}', ['name' => $name]));
                }
            }
        }
    ...
    public function bindActionParams($action, $params)
    {
        ...
        foreach ($method->getParameters() as $param) {
            if (($class = $param->getClass()) !== null) {
                ...
                if (Uni::$app->has($name) && ($obj = Uni::$app->get($name)) instanceof $className) {
                    ...
                    $args[] = Uni::$container->get($className);
                }
                continue;
            }
        ...
        if (!empty($missing)) {
            throw new Exception(Uni::t('uni', 'Missing required arguments: {params}', ['params' => implode(', ', $missing)]));
        }
     ...
     *
     * You may pass additional parameters using the constants defined in [[\uni\helpers\Console]].
     *
     * Example:
     *
     * ```
     ...
     * passing additional parameters using the constants defined in [[\uni\helpers\Console]].
     *
     * Example:
     *
     * ```
