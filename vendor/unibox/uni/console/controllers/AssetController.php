 ...
 *
 *    uni asset/template /path/to/myapp/config.php
 *
 * 2. Edit the created config file, adjusting it for your web application needs.
 * 3. Run the 'compress' action, using created config:
 *
 *    uni asset /path/to/myapp/config.php /path/to/myapp/config/assets_compressed.php
 *
 ...
 *
 * @property \uni\web\AssetManager $assetManager Asset manager instance. Note that the type of this property
...
class AssetController extends Controller
{
    ...
    /**
     * @var array|\uni\web\AssetManager [[\uni\web\AssetManager]] instance or its array configuration, which will be used
     ...
     * @throws \uni\console\Exception on invalid configuration.
     * @return \uni\web\AssetManager asset manager instance.
     */
    public function getAssetManager()
    {
        if (!is_object($this->_assetManager)) {
            ...
            if (!isset($options['class'])) {
                $options['class'] = 'uni\\web\\AssetManager';
            }
            ...
            $this->_assetManager = Uni::createObject($options);
        }
     ...
     * @param \uni\web\AssetManager|array $assetManager asset manager instance or its array configuration.
     * @throws \uni\console\Exception on invalid argument type.
     */
     ...
     * @param string $configFile configuration file name.
     * @throws \uni\console\Exception on failure.
     */
     ...
     * @return \uni\web\AssetBundle[] list of source asset bundles.
     */
     ...
     * @param \uni\web\AssetBundle $bundle bundle instance
     ...
     * @param \uni\web\AssetBundle[] $bundles list of source asset bundles.
     * @return \uni\web\AssetBundle[] list of output asset bundles.
     * @throws Exception on failure.
     */
    protected function loadTargets($targets, $bundles)
    {
        ...
        foreach ($targets as $name => $target) {
            ...
            $targets[$name] = Uni::createObject($target);
        }
     ...
     * @param \uni\web\AssetBundle $target output asset bundle
     * @param string $type either 'js' or 'css'.
     * @param \uni\web\AssetBundle[] $bundles source asset bundles.
     * @throws Exception on failure.
     */
     ...
     * @param \uni\web\AssetBundle[] $targets output asset bundles.
     * @param \uni\web\AssetBundle[] $bundles source asset bundles.
     * @return \uni\web\AssetBundle[] output asset bundles.
     */
    protected function adjustDependency($targets, $bundles)
    {
        ...
        foreach ($map as $bundle => $target) {
            ...
            $targets[$bundle] = Uni::createObject([
                'class' => strpos($bundle, '\\') !== false ? $bundle : 'uni\\web\\AssetBundle',
                'depends' => $depends,
            ]);
        }
     ...
     * @param \uni\web\AssetBundle[] $bundles asset bundles list.
     ...
     * @param \uni\web\AssetBundle[] $targets list of asset bundles to be saved.
...
<?php
/**
 * This file is generated by the "uni {$this->id}" command.
...
<?php
/**
 * Configuration file for the "uni asset" console command.
 */

// In the console environment, some path aliases may not exist. Please define these:
// Uni::setAlias('@webroot', __DIR__ . '/../web');
// Uni::setAlias('@web', '/');
...
EOD;
    ...
    {
        $config = Uni::getObjectVars($bundle);
