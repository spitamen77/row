 ...
 * uni fixture/load User --namespace=alias\my\custom\namespace\goes\here
 * ```
 *
...
class FixtureController extends Controller
{
     ...
     * uni fixture/load User UserProfile
     *
    ...
    public function actionLoad()
    {
        ...
        if ($fixturesInput === []) {
            ...
            $helpCommand = Console::ansiFormat('uni help fixture', [Console::FG_CYAN]);
     ...
     * uni fixture/unload User UserProfile
     *
    ...
    private function notifyLoaded($fixtures)
    {
        ...
        $this->stdout("\t\"" . Uni::getAlias($this->namespace) . "\"\n\n", Console::FG_GREEN);
    ...
    {
        return Uni::getAlias('@' . str_replace('\\', '/', $this->namespace));
    }
