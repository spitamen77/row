 ...
 *     return [
 *         'pageCache' => [
 *             'class' => 'uni\filters\PageCache',
 *             'only' => ['index'],
 *             'duration' => 60,
 *             'dependency' => [
 *                 'class' => 'uni\caching\DbDependency',
...
class PageCache extends ActionFilter
{
     ...
     *
     * If [[cacheCookies]] or [[cacheHeaders]] is enabled, then [[\uni\caching\Dependency::reusable]] should be enabled as well to save performance.
    ...
    public $enabled = true;
    /**
     * @var \uni\base\View the view component to use for caching. If not set, the default application view component
     * [[\uni\web\Application::view]] will be used.
     */
    public $view;
    /**
    ...
    public function beforeAction($action)
    {
        ...
        if (is_array($this->dependency)) {
            $this->dependency = Uni::createObject($this->dependency);
        }
