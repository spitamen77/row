...
use Uni;
use uni\base\ActionEvent;
use uni\base\Behavior;
use uni\web\Controller;
use uni\web\MethodNotAllowedHttpException;
 ...
 *     return [
 *         'verbs' => [
 *             'class' => \uni\filters\VerbFilter::className(),
 *             'actions' => [
 *                 'index'  => ['get'],
 *                 'view'   => ['get'],
 *                 'create' => ['get', 'post'],
...
class VerbFilter extends Behavior
{
    ...
    public function beforeAction($event)
    {
        ...
        if (!in_array($verb, $allowed)) {
            ...
            Uni::$app->getResponse()->getHeaders()->set('Allow', implode(', ', $allowed));
