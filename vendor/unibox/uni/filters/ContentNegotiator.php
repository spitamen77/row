...
use uni\web\Request;
use uni\web\UnsupportedMediaTypeHttpException;
 ...
 * If a match is found, the [[\uni\base\Application::language]] property will be set as the chosen language.
 *
...
class ContentNegotiator extends ActionFilter implements BootstrapInterface
{
    ...
    /**
     * @var string the name of the GET parameter that specifies the [[\uni\base\Application::language|application language]].
     ...
     * as declared in [[\uni\web\Response::formatters]].
     *
