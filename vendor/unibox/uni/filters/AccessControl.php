 ...
 *     return [
 *         'access' => [
 *             'class' => \uni\filters\AccessControl::className(),
 *             'only' => ['create', 'update'],
 *             'rules' => [
...
class AccessControl extends ActionFilter
{
     ...
     */
    public $ruleConfig = ['class' => 'uni\filters\AccessRule'];
    /**
    ...
    public function init()
    {
        ...
        foreach ($this->rules as $i => $rule) {
            if (is_array($rule)) {
                $this->rules[$i] = Uni::createObject(array_merge($this->ruleConfig, $rule));
            }
        }
    }
    ...
    protected function denyAccess($user)
    {
        if ($user->getIsGuest()) {
            ...
            throw new ForbiddenHttpException(Uni::t('uni', 'You are not allowed to perform this action.'));
        }
    }
}
