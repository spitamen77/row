 ...
 *     return [
 *         'corsFilter' => [
 *             'class' => \uni\filters\Cors::className(),
 *         ],
 *     ];
 * }
 * ```
...
class Cors extends ActionFilter
{
    ...
    {
        $this->request = $this->request ?: Uni::$app->getRequest();
        $this->response = $this->response ?: Uni::$app->getResponse();
     ...
     * @param \uni\base\Action $action the action settings to override
     */
    ...
    public function prepareHeaders($requestHeaders)
    {
        ...
        if (isset($this->cors['Access-Control-Max-Age']) && Uni::$app->getRequest()->getIsOptions()) {
