...
class CompareValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            switch ($this->operator) {
                case '==':
                    $this->message = Uni::t('uni', '{attribute} must be equal to "{compareValueOrAttribute}".');
                    break;
                case '===':
                    $this->message = Uni::t('uni', '{attribute} must be equal to "{compareValueOrAttribute}".');
                    break;
                case '!=':
                    $this->message = Uni::t('uni', '{attribute} must not be equal to "{compareValueOrAttribute}".');
                    break;
                case '!==':
                    $this->message = Uni::t('uni', '{attribute} must not be equal to "{compareValueOrAttribute}".');
                    break;
                case '>':
                    $this->message = Uni::t('uni', '{attribute} must be greater than "{compareValueOrAttribute}".');
                    break;
                case '>=':
                    $this->message = Uni::t('uni', '{attribute} must be greater than or equal to "{compareValueOrAttribute}".');
                    break;
                case '<':
                    $this->message = Uni::t('uni', '{attribute} must be less than "{compareValueOrAttribute}".');
                    break;
                case '<=':
                    $this->message = Uni::t('uni', '{attribute} must be less than or equal to "{compareValueOrAttribute}".');
                    break;
                default:
    ...
    public function validateAttribute($model, $attribute)
    {
        ...
        if (is_array($value)) {
            $this->addError($model, $attribute, Uni::t('uni', '{attribute} is invalid.'));
    ...
    public function clientValidateAttribute($model, $attribute, $view)
    {
        ...
        return 'uni.validation.compare(value, messages, ' . json_encode($options, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) . ');';
    }
}
