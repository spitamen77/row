...
class ImageValidator extends FileValidator
{
    ...
    public function init()
    {
        ...
        if ($this->notImage === null) {
            $this->notImage = Uni::t('uni', 'The file "{file}" is not an image.');
        }
        if ($this->underWidth === null) {
            $this->underWidth = Uni::t('uni', 'The image "{file}" is too small. The width cannot be smaller than {limit, number} {limit, plural, one{pixel} other{pixels}}.');
        }
        if ($this->underHeight === null) {
            $this->underHeight = Uni::t('uni', 'The image "{file}" is too small. The height cannot be smaller than {limit, number} {limit, plural, one{pixel} other{pixels}}.');
        }
        if ($this->overWidth === null) {
            $this->overWidth = Uni::t('uni', 'The image "{file}" is too large. The width cannot be larger than {limit, number} {limit, plural, one{pixel} other{pixels}}.');
        }
        if ($this->overHeight === null) {
            $this->overHeight = Uni::t('uni', 'The image "{file}" is too large. The height cannot be larger than {limit, number} {limit, plural, one{pixel} other{pixels}}.');
        }
    }
    ...
    public function clientValidateAttribute($model, $attribute, $view)
    {
        ...
        return 'uni.validation.image(attribute, messages, ' . json_encode($options, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) . ', deferred);';
    }
    ...
    protected function getClientOptions($model, $attribute)
    {
        ...
        if ($this->notImage !== null) {
            $options['notImage'] = Uni::$app->getI18n()->format($this->notImage, [
                'attribute' => $label
            ], Uni::$app->language);
        }
        ...
        if ($this->minWidth !== null) {
            ...
            $options['underWidth'] = Uni::$app->getI18n()->format($this->underWidth, [
                'attribute' => $label,
                'limit' => $this->minWidth
            ], Uni::$app->language);
        }
        ...
        if ($this->maxWidth !== null) {
            ...
            $options['overWidth'] = Uni::$app->getI18n()->format($this->overWidth, [
                'attribute' => $label,
                'limit' => $this->maxWidth
            ], Uni::$app->language);
        }
        ...
        if ($this->minHeight !== null) {
            ...
            $options['underHeight'] = Uni::$app->getI18n()->format($this->underHeight, [
                'attribute' => $label,
        ...
        if ($this->maxHeight !== null) {
            ...
            $options['overHeight'] = Uni::$app->getI18n()->format($this->overHeight, [
                'attribute' => $label,
