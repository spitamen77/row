...
class ExistValidator extends Validator
{
     ...
     * This can be a string or an array representing the additional query condition (refer to [[\uni\db\Query::where()]]
     * on the format of query condition), or an anonymous function with the signature `function ($query)`, where `$query`
     * is the [[\uni\db\Query|Query]] object that you can modify in the function.
     */
    public $filter;
    /**
     ...
     * @return \uni\db\ActiveQueryInterface the query instance
     */
    protected function createQuery($targetClass, $condition)
    {
        /* @var $targetClass \uni\db\ActiveRecordInterface */
