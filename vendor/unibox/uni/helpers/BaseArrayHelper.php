...
class BaseArrayHelper
{
     ...
     * ```php
     * // working with array
     * $username = \uni\helpers\ArrayHelper::getValue($_POST, 'username');
     * // working with object
     * $username = \uni\helpers\ArrayHelper::getValue($user, 'username');
     * // working with anonymous function
     * $fullName = \uni\helpers\ArrayHelper::getValue($user, function ($user, $defaultValue) {
     *     return $user->firstName . ' ' . $user->lastName;
     * });
     * // using dot format to retrieve the property of embedded object
     * $street = \uni\helpers\ArrayHelper::getValue($users, 'address.street');
     * // using an array of keys to retrieve the value
     * $value = \uni\helpers\ArrayHelper::getValue($versions, ['1.0', 'date']);
     * ```
     *
     ...
     * // working with array
     * $type = \uni\helpers\ArrayHelper::remove($array, 'type');
     * // $array content
     * // $array = ['options' => [1, 2]];
     * ```
     *
     ...
     * [[\uni\base\Application::charset]] will be used.
