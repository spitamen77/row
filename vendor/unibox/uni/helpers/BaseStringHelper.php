...
class BaseStringHelper
{
    ...
    {
        if ($asHtml) {
            return static::truncateHtml($string, $length, $suffix, $encoding ?: Uni::$app->charset);
        }
        
        if (mb_strlen($string, $encoding ?: Uni::$app->charset) > $length) {
            return trim(mb_substr($string, 0, $length, $encoding ?: Uni::$app->charset)) . $suffix;
        } else {
            return $string;
        }
    }
    ...
    protected static function truncateHtml($string, $count, $suffix, $encoding = false)
    {
        ...
        $config->set('Cache.SerializerPath', \Uni::$app->getRuntimePath());
    ...
    public static function startsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            ...
            return mb_strtolower(mb_substr($string, 0, $bytes, '8bit'), Uni::$app->charset) === mb_strtolower($with, Uni::$app->charset);
        }
    }
    ...
    public static function endsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            ...
            return mb_strtolower(mb_substr($string, -$bytes, null, '8bit'), Uni::$app->charset) === mb_strtolower($with, Uni::$app->charset);
        }
    }
