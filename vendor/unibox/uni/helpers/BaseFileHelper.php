...
class BaseFileHelper
{
     ...
     */
    public static $mimeMagicFile = '@uni/helpers/mimeTypes.php';
     ...
     * If not set, the value of [[\uni\base\Application::language]] will be used.
     * @param string $sourceLanguage the language that the original file is in.
     * If not set, the value of [[\uni\base\Application::sourceLanguage]] will be used.
    ...
    {
        if ($magicFile !== null) {
            $magicFile = Uni::getAlias($magicFile);
        }
     ...
     * @throws \uni\base\InvalidParamException if unable to open directory
     */
     ...
     * @throws \uni\base\Exception if the directory could not be created (i.e. php error due to parallel changes)
     */
    public static function createDirectory($path, $mode = 0775, $recursive = true)
    {
        ...
        try {
            ...
            if (!is_dir($path)) {// https://github.com/unisoft/uni2/issues/9288
                throw new \uni\base\Exception("Failed to create directory \"$path\": " . $e->getMessage(), $e->getCode(), $e);
            }
        }
        try {
            return chmod($path, $mode);
        } catch (\Exception $e) {
            throw new \uni\base\Exception("Failed to change permissions for directory \"$path\": " . $e->getMessage(), $e->getCode(), $e);
        }
    }
