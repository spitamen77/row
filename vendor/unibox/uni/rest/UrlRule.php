...
class UrlRule extends CompositeUrlRule
{
    ...
    public $prefix;
    /**
     * @var string the suffix that will be assigned to [[\uni\web\UrlRule::suffix]] for every generated rule.
     */
    public $suffix;
    /**
     ...
     * @param string $prefix
     * @param string $action
     * @return \uni\web\UrlRuleInterface
     */
    protected function createRule($pattern, $prefix, $action)
    {
        ...
        if (!in_array('GET', $verbs)) {
            $config['mode'] = \uni\web\UrlRule::PARSING_ONLY;
        }
