 ...
 *
 * CaptchaAction is used together with [[Captcha]] and [[\uni\captcha\CaptchaValidator]]
 ...
 *
 * 1. Override [[\uni\web\Controller::actions()]] and register an action of class CaptchaAction with ID 'captcha'
...
class CaptchaAction extends Action
{
     ...
     */
    public $fontFile = '@uni/captcha/SpicyRice.ttf';
    /**
    ...
    {
        $this->fontFile = Uni::getAlias($this->fontFile);
    ...
    public function run()
    {
        if (Uni::$app->request->getQueryParam(self::REFRESH_GET_VAR) !== null) {
            ...
            $this->setHttpHeaders();
            Uni::$app->response->format = Response::FORMAT_RAW;
    ...
    {
        Uni::$app->getResponse()->getHeaders()
            ->set('Pragma', 'public')
            ->set('Expires', '0')
