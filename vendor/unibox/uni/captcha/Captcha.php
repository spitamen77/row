 ...
 *
 * You may use [[\uni\captcha\CaptchaValidator]] to validate the user input matches
 ...
 *
 * ```php
 * <?= $form->field($model, 'captcha')->widget(\uni\captcha\Captcha::classname(), [
...
class Captcha extends InputWidget
{
     ...
     * Please refer to [[\uni\helpers\Url::toRoute()]] for acceptable formats.
     */
    ...
    public function registerClientScript()
    {
        ...
        $view->registerJs("jQuery('#$id').uniCaptcha($options);");
    }
