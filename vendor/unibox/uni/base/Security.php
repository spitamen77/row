...
class Security extends Component
{
     ...
     *
     * > Note: Uni's encryption protocol uses the same size for cipher key, HMAC signature key and key
     * derivation salt.
     */
    ...
    protected function encrypt($data, $passwordBased, $secret, $info)
    {
        ...
        if ($encrypted === false) {
            throw new \uni\base\Exception('OpenSSL failure on encryption: ' . openssl_error_string());
        }
    ...
    protected function decrypt($data, $passwordBased, $secret, $info)
    {
        ...
        if ($decrypted === false) {
            throw new \uni\base\Exception('OpenSSL failure on decryption: ' . openssl_error_string());
        }
     ...
     * $hash = Uni::$app->getSecurity()->generatePasswordHash($password);
     * // ...save $hash in database...
     *
     * // during login, validate if the password entered is correct using $hash fetched from database
     * if (Uni::$app->getSecurity()->validatePassword($password, $hash) {
     *     // password is good
     * } else {
     *     // password is bad
     * }
