...
use uni\validators\RequiredValidator;
 ...
 *
 * @property \uni\validators\Validator[] $activeValidators The validators applicable to the current
 ...
 * @property ArrayObject|\uni\validators\Validator[] $validators All the validators declared in the model.
...
class Model extends Component implements IteratorAggregate, ArrayAccess, Arrayable
{
     ...
     *
     * Uni also provides a set of [[Validator::builtInValidators|built-in validators]].
     ...
     *
     * The form name is mainly used by [[\uni\widgets\Form]] to determine how to name
     ...
     * ```
     *
     * @return ArrayObject|\uni\validators\Validator[] all the validators declared in the model.
     */
     ...
     * @return \uni\validators\Validator[] the validators applicable to the current [[scenario]].
     */
     ...
     * [[\uni\validators\RequiredValidator|required]] validation rule in the
     * current [[scenario]].
     *
     * Note that when the validator has a conditional validation applied using
     * [[\uni\validators\RequiredValidator::$when|$when]] this method will return
     ...
     * The default implementation will log a warning message if UNI_DEBUG is on.
    ...
    {
        if (UNI_DEBUG) {
            Uni::trace("Failed to set unsafe attribute '$name' in '" . get_class($this) . "'.", __METHOD__);
        }
    }
