 ...
 * ```
 *
 * where `as tree` stands for attaching a behavior named `tree`, and the array will be passed to [[\Uni::createObject()]]
...
class Component extends BaseObject
{
    ...
    public function __set($name, $value)
    {
        ...
        if (method_exists($this, $setter)) {
            ...
            $this->attachBehavior($name, $value instanceof Behavior ? $value : Uni::createObject($value));
     ...
     *  - an object configuration array that will be passed to [[Uni::createObject()]] to create the behavior object.
     *
    ...
    private function attachBehaviorInternal($name, $behavior)
    {
        if (!($behavior instanceof Behavior)) {
            $behavior = Uni::createObject($behavior);
        }
        if (is_int($name)) {
