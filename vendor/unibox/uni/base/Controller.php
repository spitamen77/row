 ...
 * read-only.
 * @property View|\uni\web\View $view The view object that can be used to render views or view files.
...
class Controller extends Component implements ViewContextInterface
{
     ...
     * ```
     *
     * [[\Uni::createObject()]] will be used later to create the requested action
    ...
    public function runAction($id, $params = [])
    {
        ...
        Uni::trace('Route to run: ' . $action->getUniqueId(), __METHOD__);

        if (Uni::$app->requestedAction === null) {
            Uni::$app->requestedAction = $action;
        }
    ...
    public function run($route, $params = [])
    {
        ...
        if ($pos === false) {
            ...
            return Uni::$app->runAction(ltrim($route, '/'), $params);
        }
    }
    ...
    public function createAction($id)
    {
        ...
        if (isset($actionMap[$id])) {
            return Uni::createObject($actionMap[$id], [$id, $this]);
     ...
     * @return View|\uni\web\View the view object that can be used to render views or view files.
     */
    public function getView()
    {
        if ($this->_view === null) {
            $this->_view = Uni::$app->getView();
        }
        return $this->_view;
    }
     ...
     * @param View|\uni\web\View $view the view object that can be used to render views or view files.
     */
    ...
    public function findLayoutFile($view)
    {
        ...
        if (strncmp($layout, '@', 1) === 0) {
            $file = Uni::getAlias($layout);
        } elseif (strncmp($layout, '/', 1) === 0) {
            $file = Uni::$app->getLayoutPath() . DIRECTORY_SEPARATOR . substr($layout, 1);
        } else {
