...
class Module extends ServiceLocator
{
    ...
    public static function getInstance()
    {
        ...
        return isset(Uni::$app->loadedModules[$class]) ? Uni::$app->loadedModules[$class] : null;
    }
    ...
    {
        if ($instance === null) {
            unset(Uni::$app->loadedModules[get_called_class()]);
        } else {
            Uni::$app->loadedModules[get_class($instance)] = $instance;
        }
    }
    ...
    {
        return Uni::getAlias('@' . str_replace('\\', '/', $this->controllerNamespace));
    }
    ...
    {
        $this->_viewPath = Uni::getAlias($path);
    }
    ...
    {
        $this->_layoutPath = Uni::getAlias($path);
    }

    /**
     * Defines path aliases.
     * This method calls [[Uni::setAlias()]] to register the path aliases.
    ...
    public function getModule($id, $load = true)
    {
        ...
        if (isset($this->_modules[$id])) {
            if ($this->_modules[$id] instanceof Module) {
                ...
                Uni::trace("Loading module: $id", __METHOD__);
                /* @var $module Module */
                $module = Uni::createObject($this->_modules[$id], [$id, $this]);
     ...
     * array that can be used to create the module. In the latter case, [[Uni::createObject()]]
    ...
    public function runAction($route, $params = [])
    {
        ...
        if (is_array($parts)) {
            ...
            $oldController = Uni::$app->controller;
            Uni::$app->controller = $controller;
            $result = $controller->runAction($actionID, $params);
            Uni::$app->controller = $oldController;
    ...
    public function createController($route)
    {
        ...
        if (isset($this->controllerMap[$id])) {
            $controller = Uni::createObject($this->controllerMap[$id], [$id, $this]);
    ...
    public function createControllerByID($id)
    {
        ...
        if (is_subclass_of($className, 'uni\base\Controller')) {
            $controller = Uni::createObject($className, [$id, $this]);
            return get_class($controller) === $className ? $controller : null;
        } elseif (UNI_DEBUG) {
            throw new InvalidConfigException("Controller class must extend from \\uni\\base\\Controller.");
        } else {
            return null;
        }
    }
