...
abstract class Target extends Component
{
     ...
     * match those categories sharing the same common prefix. For example, 'uni\db\*' will match
     * categories starting with 'uni\db\', such as 'uni\db\Connection'.
     */
    public $categories = [];
    /**
    ...
    public function collect($messages, $final)
    {
        ...
        if ($count > 0 && ($final || $this->exportInterval > 0 && $count >= $this->exportInterval)) {
            if (($context = $this->getContextMessage()) !== '') {
                $this->messages[] = [$context, Logger::LEVEL_INFO, 'application', UNI_BEGIN_TIME];
            }
    ...
    public function getMessagePrefix($message)
    {
        ...
        /* @var $user \uni\web\User */
        $user = Uni::$app->has('user', true) ? Uni::$app->get('user') : null;
