 ...
 *
 * An instance of Dispatcher is registered as a core application component and can be accessed using `Uni::$app->log`.
 *
 ...
 *
 * ```php
 * Uni::$app->log->targets['file']->enabled = false;
 * ```
 *
 ...
 * @property Logger $logger The logger. If not set, [[\Uni::getLogger()]] will be used.
...
class Dispatcher extends Component
{
    ...
    public function init()
    {
        ...
        foreach ($this->targets as $name => $target) {
            if (!$target instanceof Target) {
                $this->targets[$name] = Uni::createObject($target);
            }
        }
    }
     ...
     * If not set, [[\Uni::getLogger()]] will be used.
     * @property Logger the logger. If not set, [[\Uni::getLogger()]] will be used.
     * @return Logger the logger.
     */
    public function getLogger()
    {
        if ($this->_logger === null) {
            $this->setLogger(Uni::getLogger());
        }
        return $this->_logger;
    }
