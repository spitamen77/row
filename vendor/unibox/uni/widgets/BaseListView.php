...
abstract class BaseListView extends Widget
{
    ...
    public $options = [];
    /**
     * @var \uni\data\DataProviderInterface the data provider for the view. This property is required.
     */
    public $dataProvider;
    /**
     ...
     * [[\uni\data\BaseDataProvider::pagination|pagination]] value of the [[dataProvider]].
     */
    public $pager = [];
    /**
     ...
     * [[\uni\data\BaseDataProvider::sort|sort]] value of the [[dataProvider]].
     */
    public $sorter = [];
    /**
    ...
    public function init()
    {
        ...
        if ($this->emptyText === null) {
            $this->emptyText = Uni::t('uni', 'No results found.');
        }
    ...
    public function renderSummary()
    {
        ...
        if (($pagination = $this->dataProvider->getPagination()) !== false) {
            ...
            if (($summaryContent = $this->summary) === null) {
                return Html::tag($tag, Uni::t('uni', 'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{item} other{items}}.', [
                        'begin' => $begin,
                        'end' => $end,
                        'count' => $count,
            ...
            if (($summaryContent = $this->summary) === null) {
                return Html::tag($tag, Uni::t('uni', 'Total <b>{count, number}</b> {count, plural, one{item} other{items}}.', [
                    'begin' => $begin,
                    'end' => $end,
                    'count' => $count,
                    'totalCount' => $totalCount,
        ...
        return Uni::$app->getI18n()->format($summaryContent, [
            'begin' => $begin,
            'end' => $end,
            'count' => $count,
            'totalCount' => $totalCount,
