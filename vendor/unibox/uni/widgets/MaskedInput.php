 ...
 * ```
 *
 * You can also use this widget in an [[uni\widgets\Form|Form]] using the [[uni\widgets\Field::widget()|widget()]]
 * method, for example like this:
 *
 * ```php
 * <?= $form->field($model, 'from_date')->widget(\uni\widgets\MaskedInput::className(), [
 *     'mask' => '999-999-9999',
 * ]) ?>
 * ```
 *
