...
/**
 * Field represents a form input field within an [[Form]].
 *
...
{
    /**
     * @var Form the form that this field is associated with.
     */
    public $form;
    /**
     ...
     * If not set, it will take the value of [[Form::validationDelay]].
     */
     ...
     *   by a string validator, the `maxlength` option will take the value of [[\uni\validators\StringValidator::max]].
     ...
     * use [[\uni\helpers\Html::activeHiddenInput()]].
     *
     * This method will generate the "name" and "value" tag attributes automatically for the model attribute
     * unless they are explicitly specified in `$options`.
     * @param array $options the tag options in terms of name-value pairs. These will be rendered as
    ...
    {
        // https://github.com/unisoft/uni2/pull/795
     ...
     *
     * For the list of available options please refer to the `$options` parameter of [[\uni\helpers\Html::activeDropDownList()]].
     *
     * If you set a custom `id` for the input element, you may need to adjust the [[$selectors]] accordingly.
     *
     * @return $this the field object itself
     ...
     * For each sub-array, an option group will be generated whose label is the key associated with the sub-array.
     * If you have a list of data models, you may convert them into the format described above using
     * [[\uni\helpers\ArrayHelper::map()]].
     *
     * Note, the values and labels will be automatically HTML-encoded by this method, and the blank spaces in
     * the labels will also be HTML-encoded.
     * @param array $options the tag options in terms of name-value pairs.
     *
     * For the list of available options please refer to the `$options` parameter of [[\uni\helpers\Html::activeListBox()]].
     *
     * If you set a custom `id` for the input element, you may need to adjust the [[$selectors]] accordingly.
     *
     * @return $this the field object itself
     ...
     * For the list of available options please refer to the `$options` parameter of [[\uni\helpers\Html::activeCheckboxList()]].
     * @return $this the field object itself
     */
     ...
     * For the list of available options please refer to the `$options` parameter of [[\uni\helpers\Html::activeRadioList()]].
     * @return $this the field object itself
     */
     ...
     * the following code, assuming that `$form` is your [[Form]] instance:
     *
     * ```php
     * $form->field($model, 'date')->widget(\uni\widgets\MaskedInput::className(), [
     *     'mask' => '99/99/9999',
     * ]);
     * ```
     *
    ...
    protected function getClientOptions()
    {
        ...
        if ($enableClientValidation) {
            ...
            foreach ($this->model->getActiveValidators($attribute) as $validator) {
                /* @var $validator \uni\validators\Validator */
