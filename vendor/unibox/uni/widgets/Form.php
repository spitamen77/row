...
/**
 * Form is a widget that builds an interactive HTML form for one or multiple data models.
 *
...
{
    /**
     * @var array|string $action the form action URL. This parameter will be processed by [[\uni\helpers\Url::to()]].
     ...
     * @see fieldConfig
     */
    public $fieldClass = 'uni\widgets\Field';
    /**
     ...
     * If [[Field::enableClientValidation]] is set, its value will take precedence for that input field.
     */
    public $enableClientValidation = true;
    /**
     * @var boolean whether to enable AJAX-based data validation.
     * If [[Field::enableAjaxValidation]] is set, its value will take precedence for that input field.
     */
    public $enableAjaxValidation = false;
    /**
     * @var boolean whether to hook up uni.activeForm JavaScript plugin.
     * This property must be set true if you want to support client validation and/or AJAX validation, or if you
     * want to take advantage of the uni.activeForm plugin. When this is false, the form will not generate
     * any JavaScript.
     */
     ...
     * If [[Field::validateOnChange]] is set, its value will take precedence for that input field.
     */
    public $validateOnChange = true;
    /**
     * @var boolean whether to perform validation when an input field loses focus.
     * If [[Field::$validateOnBlur]] is set, its value will take precedence for that input field.
     */
    public $validateOnBlur = true;
    /**
     * @var boolean whether to perform validation while the user is typing in an input field.
     * If [[Field::validateOnType]] is set, its value will take precedence for that input field.
     * @see validationDelay
     */
     ...
     * If [[Field::validationDelay]] is set, its value will take precedence for that input field.
     */
    ...
    /**
     * @var Field[] the Field objects that are currently active
     */
    private $_fields = [];
    ...
    public function run()
    {
        ...
        if ($this->enableClientScript) {
            ...
            $view->registerJs("jQuery('#$id').form($attributes, $options);");
        }
    ...
    protected function getClientOptions()
    {
        ...
        // only get the options that are different from the default ones (set in uni.Form.js)
        return array_diff_assoc($options, [
            'encodeErrorSummary' => true,
            'errorSummary' => '.error-summary',
            'validateOnSubmit' => true,
            'errorCssClass' => ' md-input-wrapper-danger',
            'successCssClass' => 'md-input-wrapper-success',
     ...
     * be HTML-encoded using [[\uni\helpers\Html::encode()]]. If a value is null, the corresponding attribute will not be rendered.
     ...
     * @param array $options the additional configurations for the field object. These are properties of [[Field]]
    ...
    public function field($model, $attribute, $options = [])
    {
        ...
        return Uni::createObject(ArrayHelper::merge($config, $options, [
            'model' => $model,
            'attribute' => $attribute,
            'form' => $this,
        ]));
     ...
     * if (Uni::$app->request->isAjax) {
     *     Uni::$app->response->format = Response::FORMAT_JSON;
     *     return Form::validateMultiple($models);
     * }
     * // ... respond to non-AJAX request ...
     * ```
     *
