...
class LinkPager extends Widget
{
     ...
     */
    public $options = ['class' => 'uk-pagination uk-margin-medium-top'];
    /**
     ...
     */
    public $firstPageCssClass = 'uk-icon-angle-double-left';
    /**
     * @var string the CSS class for the "last" page button.
     */
    public $lastPageCssClass = 'uk-icon-angle-double-right';
    /**
     ...
     * These links are generated using [[\uni\data\Pagination::getLinks()]].
     * @see http://www.w3.org/TR/html401/struct/links.html#h-12.1.2
     */
