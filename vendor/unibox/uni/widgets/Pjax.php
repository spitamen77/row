...
/**
 * Pjax is a widget integrating the [pjax](https://github.com/unibox/jquery-pjax) jQuery plugin.
 *
 ...
 *
 * The following example shows how to use Pjax with the [[\uni\grid\GridView]] widget so that the grid pagination,
...
class Pjax extends Widget
{
     ...
     * [pjax project page](https://github.com/unibox/jquery-pjax) for available options.
     */
    ...
    public function run()
    {
        ...
        // This is a temporary fix for https://github.com/unisoft/uni2/issues/2310
