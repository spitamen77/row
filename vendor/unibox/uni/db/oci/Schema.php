...
use uni\db\TableSchema;
use uni\db\ColumnSchema;
 ...
 * @since alfa version
 */
class Schema extends \uni\db\Schema
{
    /**
     ...
     */
    public $exceptionMap = [
        'ORA-00001: unique constraint' => 'uni\db\IntegrityException',
    ];
...
SQL;
     ...
     * @internal param \uni\db\TableSchema $table->name the table schema
...
SQL;
        ...
        foreach ($command->queryAll() as $row) {
            ...
            if ($row['CONSTRAINT_TYPE'] !== 'R') {
                ...
                // see https://github.com/unisoft/uni2/pull/8844
                continue;
            }
