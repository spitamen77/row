 ...
 *
 * Migration is designed to be used together with the "uni migrate" command.
 *
 ...
 * logic. The "uni migrate" command manages all available migrations in an application.
 *
