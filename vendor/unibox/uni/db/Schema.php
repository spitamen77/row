...
abstract class Schema extends BaseObject
{
     ...
     */
    public $exceptionMap = [
        'SQLSTATE[23' => 'uni\db\IntegrityException',
    ];
    ...
    /**
     * @return \uni\db\ColumnSchema
     * @throws \uni\base\InvalidConfigException
     */
    protected function createColumnSchema()
    {
        return Uni::createObject('uni\db\ColumnSchema');
    }
    ...
    public function getTableSchema($name, $refresh = false)
    {
        ...
        if ($db->enableSchemaCache && !in_array($name, $db->schemaCacheExclude, true)) {
            /* @var $cache Cache */
            $cache = is_string($db->schemaCache) ? Uni::$app->get($db->schemaCache, false) : $db->schemaCache;
    ...
    {
        /* @var $cache Cache */
        $cache = is_string($this->db->schemaCache) ? Uni::$app->get($this->db->schemaCache, false) : $this->db->schemaCache;
    ...
    public function convertException(\Exception $e, $rawSql)
    {
        ...
        $exceptionClass = '\uni\db\Exception';
