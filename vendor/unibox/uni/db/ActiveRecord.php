 ...
 *
 * To declare an ActiveRecord class you need to extend [[\uni\db\ActiveRecord]] and
 * implement the `tableName` method:
 *
 * ```php
 * <?php
 *
 * class Customer extends \uni\db\ActiveRecord
 * {
 ...
 *
 * > Tip: You may also use the [Gii code generator](guide:start-generator) to generate ActiveRecord classes from your
 * > database tables.
 *
...
class ActiveRecord extends BaseActiveRecord
{
    ...
    {
        return Uni::createObject(ActiveQuery::className(), [get_called_class()]);
    }
    ...
    public function insert($runValidation = true, $attributes = null)
    {
        if ($runValidation && !$this->validate($attributes)) {
            Uni::info('Model not inserted due to validation error.', __METHOD__);
            return false;
        }
    ...
    public function update($runValidation = true, $attributeNames = null)
    {
        if ($runValidation && !$this->validate($attributeNames)) {
            Uni::info('Model not updated due to validation error.', __METHOD__);
            return false;
        }
