...
/**
 * uni is the root module for all Uni JavaScript modules.
 * It implements a mechanism of organizing JavaScript code in modules through the function "uni.initModule()".
 *
 * Each module should be named as "x.y.z", where "x" stands for the root module (for the Uni core code, this is "uni").
 *
 ...
 * may be accessed outside of the module. For example, you can access "uni.sample.isActive".
 *
 * You must call "uni.initModule()" once for the root module of all your modules.
 */
uni = (function ($) {
    var pub = {
        /**
         ...
         * You may override this by setting `uni.confirm`.
        ...
        handleAction: function ($e, event) {
            ...
            var activeFormData = $form.data('form');
            if (activeFormData) {
                // remember who triggers the form submission. This is used by uni.Form.js
            ...
            $form.trigger('submit');
            $.when($form.data('uniSubmitFinalizePromise')).then(
                function () {
                    if (oldAction != null) {
    ...
    function initDataMethods() {
        ...
        $(document).on('click.uni', pub.clickableSelector, handler)
            .on('change.uni', pub.changeableSelector, handler);
    }
