...
/* @var $handler \uni\web\ErrorHandler */
?>
...
<head>
    ...
    <title><?php
        ...
        if ($exception instanceof \uni\web\HttpException) {
...
<body>
    <div class="header">
        <?php if ($exception instanceof \uni\base\ErrorException): ?>
        ...
        <?php if ($exception instanceof \uni\db\Exception && !empty($exception->errorInfo)) {
...
window.onload = function() {
    ...
    <?php if (method_exists($this, 'endBody')) $this->endBody(); // to allow injecting code into body (mostly by Uni Debug Toolbar) ?>
</body>
