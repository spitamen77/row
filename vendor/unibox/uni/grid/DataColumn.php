...
class DataColumn extends Column
{
     ...
     * of [[\uni\db\ActiveRecord]], the label will be determined using [[\uni\db\ActiveRecord::getAttributeLabel()]].
     * Otherwise [[\uni\helpers\Inflector::camel2words()]] will be used to get a label.
     */
    public $label;
    /**
     ...
     * [[\uni\i18n\Formatter]] is used as the [[GridView::$formatter|formatter]] of the GridView.
     */
    public $format = 'text';
    /**
     ...
     * generated by [[\uni\data\Sort::link]] when sorting is enabled for this column.
