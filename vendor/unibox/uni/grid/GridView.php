...
class GridView extends BaseListView
{
     ...
     * Defaults to 'uni\grid\DataColumn'.
     */
     ...
     * the [[\uni\i18n\Formatter::nullDisplay|nullDisplay]] property of the [[formatter]] will
     * be used to indicate an empty data value.
     */
    public $emptyCell = '&nbsp;';
    /**
     * @var \uni\base\Model the model that keeps the user-entered filter data. When this property is set,
    ...
    public function init()
    {
        ...
        if ($this->formatter === null) {
            $this->formatter = Uni::$app->getFormatter();
        } elseif (is_array($this->formatter)) {
            $this->formatter = Uni::createObject($this->formatter);
        }
    ...
    public function run()
    {
        ...
        $view->registerJs("jQuery('#$id').uniGridView($options);");
        parent::run();
    }
    ...
    {
        $filterUrl = isset($this->filterUrl) ? $this->filterUrl : Uni::$app->request->url;
    ...
    protected function initColumns()
    {
        ...
        foreach ($this->columns as $i => $column) {
            if (is_string($column)) {
                ...
                $column = Uni::createObject(array_merge([
