 ...
 * @package uni-widgets
 * @subpackage uni-widget-fileinput
 * @version 1.0.3
 */
...
class FileInput extends \kartik\base\InputWidget
{
    ...
    public function init()
    {
        ...
        if ($this->showMessage) {
            ...
            $message = '<strong>' . Uni::t('fileinput', 'Note:') . '</strong> ' . Uni::t('fileinput', 'Your browser does not support {validation}. Try an alternative or more recent browser to access these features.', ['validation' => $validation]);
