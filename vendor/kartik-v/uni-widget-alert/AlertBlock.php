 ...
 * @since 1.0
 */
class AlertBlock extends \uni\bootstrap\Widget
{
    ...
    /**
     * @var bool whether to automatically use messages set via `Uni::$app->session->setFlash()`. Defaults to `true`.
    ...
    protected function initOptions()
    {
        if ($this->type == self::TYPE_GROWL) {
            Config::checkDependency('growl\Growl', 'uni-widget-growl', 'for rendering Growl notifications in the alert block');
        }
