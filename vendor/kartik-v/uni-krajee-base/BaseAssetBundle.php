...
{
    /**
     * Unique value to set an empty asset via Uni AssetManager configuration.
     */
    const EMPTY_ASSET = 'N0/@$$3T$';
    /**
     * Unique value to set an empty asset file path via Uni AssetManager configuration.
     */
    ...
    public function addLanguage($lang = '', $prefix = '', $dir = null, $min = false)
    {
        ...
        $ext = $min ? (UNI_DEBUG ? ".min.js" : ".js") : ".js";
    ...
    protected function setupAssets($type, $files = [])
    {
        if ($this->$type === self::KRAJEE_ASSET) {
            ...
            $this->$type = UNI_DEBUG ? $srcFiles : $minFiles;
