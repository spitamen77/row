 ...
 * @package uni-widgets
 * @subpackage uni-widget-datetimepicker
 * @version 1.4.2
 */
...
/**
 * DateTimePicker widget is a Uni2 wrapper for the Bootstrap DateTimePicker plugin by smalot
...
class DateTimePicker extends InputWidget
{
    ...
    public function init()
    {
        ...
        $dir = Uni::getAlias('@vendor/kartik-v/uni-widget-datetimepicker');
        $this->initI18N($dir);
    ...
    protected function renderAddon(&$options, $type = 'picker')
    {
        ...
        if (empty($options['title'])) {
            $title = ($type === 'picker') ? Uni::t('kvdtime', 'Select date & time') : Uni::t('kvdtime', 'Clear field');
            if ($title != false) {
                $options['title'] = $title;
            }
        }
