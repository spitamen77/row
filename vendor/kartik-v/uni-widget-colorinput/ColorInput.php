    ...
    public function run()
    {
        ...
        if (substr($this->language, 0, 2) !== 'en') {
            $this->_defaultOptions += [
                'cancelText' => Uni::t('kvcolor', 'cancel'),
                'chooseText' => Uni::t('kvcolor', 'choose'),
                'clearText' => Uni::t('kvcolor', 'Clear Color Selection'),
                'noColorSelectedText' => Uni::t('kvcolor', 'No Color Selected'),
                'togglePaletteMoreText' => Uni::t('kvcolor', 'more'),
                'togglePaletteLessText' => Uni::t('kvcolor', 'less'),
            ];
        }
