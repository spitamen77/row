...
class DepDrop extends InputWidget
{
     ...
     *
     * - 1 or [[DepDrop::TYPE_DEFAULT]] will render using \uni\helpers\Html::dropDownList
    ...
    public function run()
    {
        ...
        if ($this->type === self::TYPE_SELECT2) {
            Config::checkDependency('select2\Select2', 'uni-widget-select2', 'for dependent dropdown for Select2');
        }
