...
/**
 * Select2 widget is a Uni2 wrapper for the Select2 jQuery plugin. This input widget is a jQuery based replacement for
...
class Select2 extends InputWidget
{
    ...
    protected function renderToggleAll()
    {
        ...
        $settings = array_replace_recursive([
            'selectLabel' => '<i class="glyphicon glyphicon-unchecked"></i>' . Uni::t('kvselect', 'Select all'),
            'unselectLabel' => '<i class="glyphicon glyphicon-check"></i>' . Uni::t('kvselect', 'Unselect all'),
            'selectOptions' => [],
            'unselectOptions' => [],
