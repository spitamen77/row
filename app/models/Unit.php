...
/**
 * This is the model class for table "vk_unit".
 *
 * @property integer $id
 ...
 */
class Unit extends \uni\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Prixod::className(), ['unit_id' => 'id']);
    }

    public function getMeasure()
    {
        return $this->hasMany(UnitMeasure::className(), ['unit_id' => 'id']);
    }
}
