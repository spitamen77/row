            ...
            'value' => function ($data) {
                ...
                if ($data['type'] !== 'batch') {
                    $query .= Html::tag(
                        'div',
                        implode('<br>', [
                            Html::a('&gt;&gt; Execute', ['request-execute', 'seq' => $data['seq'], 'tag' => Uni::$app->controller->summary['tag']], ['target' => '_blank']),
                            Html::a('&gt;&gt; Pass Through', ['request-execute', 'seq' => $data['seq'], 'tag' => Uni::$app->controller->summary['tag'], 'passthru' => true], ['target' => '_blank']),
                        ]),
                        ['class' => 'db-explain']
                    );
                }
