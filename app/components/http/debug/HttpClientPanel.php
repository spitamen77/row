...
class HttpClientPanel extends Panel
{
    ...
    public function getSummary()
    {
        ...
        return Uni::$app->view->render('@app/modules/nextadmin/components/http/debug/views/summary', [
            'timings' => $this->calculateTimings(),
            'panel' => $this,
    ...
    public function getDetail()
    {
        ...
        return Uni::$app->view->render('@app/modules/nextadmin/components/http/debug/views/detail', [
            'panel' => $this,
    ...
    public function calculateTimings()
    {
        if ($this->_timings === null) {
            $this->_timings = Uni::getLogger()->calculateTimings(isset($this->data['messages']) ? $this->data['messages'] : []);
        }
