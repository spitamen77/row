...
<!--            </div>-->
        ...
        <div class="md-card-content large-padding uk-position-relative" id="login_help" style="display: none">
            ...
            <p>If your password still isn’t working, it’s time to <a href="#" class='password_reset_show' >reset your password</a>.</p>
        </div>
        ...
        <div class="md-card-content large-padding login-box" id="login_password_reset" style="display: none">
            ...
            <form class="user-for forgotpass-form text-center form-open form-active" id="forgot-password">
                <h1 class="form-heading"> Forgot Password </h1>
                <div class="form-group">
                    <input type="email" name="femail" class="form-control" id="femail" required="" placeholder="Email Address">
                    <i class="fa fa-envelope input-icon"></i>
                </div>
                <button type="submit" value="login" name="sign-up" class="btn btn-block btn-login text-uppercase">
                    Recover Password
                </button>
                <p class="forgot-password margin-bottom-0">
                    You have an account allready?
                    <a class="login-frm-button margin-tp back_to_login" href="#">Login</a>
                </p>
                <p class="status">
                </p>
