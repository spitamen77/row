...
$this->title = Uni::t('app', 'Vaccine')." | ".$prixod->vilprixod->nomer;
                ...
                <?php if (!empty($viloyat->models)): ?>
                    <? foreach ($viloyat->models as $model) {  ?>
                        <tr id='row_<?=$model->id?>' >
                            ...
                            <td class="uk-width-2-10 "><?//=$model->user->phone?></td>
                            ...
                            <td class="uk-width-1-10 uk-text-center"><?=date('d-m-Y', $model->vaksina_date)?></td>
                            ...
                            <td class="uk-text-center">
                                <a type="button" href="<?=Url::to("vaksinatsiya/vaksina/user/$model->vaksina_id/$model->uchastka_id")?>"><i class="md-icon material-icons uk-text-primary eye">&#xE417;</i></a>
                            </td>
                        </tr>
