    ...
    <div class="uk-row-first" style="">
        <div class="md-card">
            <div class="md-card-content">
                ...
                <h2 class="uk-margin-remove"><span class="countUpMe"><?=Prixod::getCount($viloyat_id, $tuman_id)?></span></h2>
            </div>
        </div>
    </div>
    <div style="">
        <div class="md-card">
            <div class="md-card-content">
                ...
                <h2 class="uk-margin-remove"><span class="countUpMe"><?=(Prixod::getRasxod($viloyat_id, $tuman_id)==0)? 0: Prixod::getRasxod($viloyat_id, $tuman_id)?></span></h2>
            </div>
        </div>
    </div>
    <div style="">
        <div class="md-card">
            <div class="md-card-content">
                ...
                <h2 class="uk-margin-remove"><span class="countUpMe"><?=(Prixod::getKutish($viloyat_id, $tuman_id)==0)? 0: Prixod::getKutish($viloyat_id, $tuman_id)?></span></h2>
            </div>
        </div>
    </div>
    <div style="">
        <div class="md-card">
            <div class="md-card-content">
                ...
                <h2 class="uk-margin-remove"><span class="countUpMe"><?=(Prixod::getOtkaz($viloyat_id, $tuman_id)==0)? 0: Prixod::getOtkaz($viloyat_id, $tuman_id)?></span></h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="md-card">
            <div class="md-card-content">
                ...
                <ul id="tabs_4" class="uk-switcher uk-margin">
                        ...
                        <div class="md-card-content">
                            <div class="uk-overflow-container">
                                <table class="uk-table uk-table-nowrap uk-table-hover table_check">
                                    ...
                                    <tbody>
                                    <?php foreach (Prixod::getAccepted($viloyat_id, $tuman_id) as $item): ?>
                                        <tr>
                                            <td><?=$item->tuman->name; ?></td>
                                            <td class="uk-text-center"><?=$item->nomer?></td>
                                            <td class="uk-text-center"><?=date('d-m-Y', $item->vaksina_date)?></td>
                        ...
                        <div class="md-card-content">
                            <div class="uk-overflow-container">
                                <table class="uk-table uk-table-nowrap table_check">
                                    ...
                                    <tbody>
                                    <?php foreach (Prixod::getNew($viloyat_id, $tuman_id) as $item): ?>
                                        <tr>
                                            <td><?=$item->tuman->name; ?></td>
                                            <td class="uk-text-center"><?=$item->nomer?></td>
                                            <td class="uk-text-center"><?=date('d-m-Y', $item->vaksina_date)?></td>
                    ...
                    <?php endif; ?>
                    <?php if (!empty(Prixod::getDenied($viloyat_id, $tuman_id))): ?>
                        <div class="md-card-content">
                            <div class="uk-overflow-container">
                                <table class="uk-table uk-table-nowrap table_check">
                                    <thead>
                                    ...
                                    <tbody>
                                    <?php foreach (Prixod::getDenied($viloyat_id, $tuman_id) as $item): ?>
                                        <tr>
                                            <td><?=$item->tuman->name; ?></td>
                                            <td class="uk-text-center"><?=$item->nomer?></td>
                                            <td class="uk-text-center"><?=date('d-m-Y', $item->vaksina_date)?></td>
