...
$viloyat = \app\models\Tuman::findOne($tuman_id);
    ...
    <div class="block-process" style="margin-bottom:10px;">
        <div class="uk-grid">
            <div class="uk-width-1-2">
                ...
                <a class="md-btn md-btn-primary md-btn-small" onclick="window.location.reload()"><?=Uni::t('app','All')?></a>
<!--                <button id="modal_add_VkTuman_btn" data-uk-modal="{bgClose:true;modal:true}" class="md-btn md-btn-facebook md-btn-small" >--><?//=Uni::t('app','Add')?><!--</button>-->
                    ...
                    <table class="uk-table uk-table-hover">
                        ...
                        <? foreach ($data->models as $value) : ?>
                            <tr>
                                ...
                                <td><a href="<?=Url::to("settings/viloyat/user?sir=$value->id&reg=".$value->viloyat->id."&tum=$tuman_id")?>"><i class="md-icon material-icons uk-text-primary eye">&#xE417;</i></a></td>
                            </tr>
                        <? endforeach; ?>
                        </tbody>
                    </table>
    ...
    <div class="uk-modal" id="modal_add_VkTuman">
        <div class="uk-modal-dialog">
            ...
            <input type="hidden" name="Vktuman[viloyat_id]" value="<?=$tuman_id?>" />
            <br/>
