                ...
                <?php foreach ($dataProvider->models as $model) {?>
                    <tr id="row_<?=$model->id ?>">
                        ...
                        <td class="uk-text-center">
                            <span type="button" style="cursor: pointer;" class="uk-badge uk-badge-primary accept" id="accept" data-id="<?=$model->id?>">Qabul qilish</span>
                                <!-- <span class="uk-badge uk-badge-primary">New</span> -->
                            <span type="button" style="cursor: pointer;" class="uk-badge uk-badge-danger deny" id="deny" data-id="<?=$model->id?>">Bekor qilish</span>
                        </td>
                    </tr>
                <?}?>
                </tbody>
...
$this->registerJs('
    $(".accept").click(function(){
        ...
        $.post("/settings/vktuman/accept/"+id,{data:id},function(response){
    ...
    $(".deny").click(function(){
        ...
        $.post("/settings/vktuman/deny/"+id,{data:id},function(response){
