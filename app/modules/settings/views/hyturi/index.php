...
$this->registerJs('Muxr.saveHyturi();Muxr.openClearedDirection();Muxr.openDirectionForm();Muxr.openEditHyturiForm();Muxr.editHyturiStatus();');
$q=false;
if(isset($_GET['q'])){
    $q=$_GET['q'];
}
$current = Lang::getCurrent();
$this->title = Uni::t('app', 'Animal type');
?>
    <div class="block-process" style="margin-bottom:10px;">
        <div class="uk-grid">
            <div class="uk-width-1-2">
                <a class="md-btn md-btn-success md-btn-small" href="<?=Url::to('settings/hyturi/index')?>"><?=Uni::t('app','All')?></a>
                <button id="modal_add_direction_btn" data-uk-modal="{bgClose:true;modal:true}" class="md-btn md-btn-facebook md-btn-small" ><?=Uni::t('app', 'Add drug')?></button>
            </div>
            <div class="uk-width-1-2">
                <form method="get">
                    <div class="uk-grid">
        ...
        <div class="md-card-content">
            <table class="uk-table uk-table-nowrap table_check">
                ...
                <tr>
                    ...
                    <th class="uk-width-2-10"><?= Uni::t('app', 'Drug name') ?></th>
    ...
    <div class="uk-modal" id="modal_view" aria-hidden="true" style="display: none; overflow-y: scroll;">
        <div class="uk-modal-dialog" style="top: 34.5px;">
            <div class="uk-modal-header">
                <h3 class="uk-modal-title"><?= Uni::t('app', 'Animal type') ?></h3>
            </div>
...
$this->registerJs(' /*ko`rish oynasi*/
    $("i.eye").click(function(e){
        ...
        $.get("../hyturi/view",{id: model},function(response){
            if(response!="error"){
