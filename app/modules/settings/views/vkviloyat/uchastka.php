            ...
            <div class="uk-overflow-container">
                <table class="uk-table uk-table-hover">
                    ...
                    <tr>
                        <td><?=$value['vaksina']?></td>
                        <td><?=$value['miqdor']?></td>
                        <td><a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="<?=Url::to('settings/vkviloyat/vaksinatsiya/'.$value['id'])?>">Batafsil</a></td>
                    </tr>
                    <? endforeach; ?>
                    </tbody>
                </table>
