        ...
        <div class="md-card-content">
            <div class="uk-overflow-container">
                <table class="uk-table uk-table-hover">
                    ...
                    <tr>
                        <td><?=($value->vaksina)?$value->vaksina->name_uz:Uni::t('app','Not found')?></td>
                        <td><?=$value->vaksina_miqdor?></td>
                        <td><?=$value->created_at?></td>
                        <td><a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="<?=Url::to('settings/vkviloyat/item/'.$value['id'])?>">Batafsil</a></td>
                    </tr>
                    <? endforeach; ?>
                    </tbody>
                </table>
