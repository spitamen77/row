...
$this->registerJs('Muxr.saveVkTuri();Muxr.openClearedDirection();Muxr.openDirectionForm();Muxr.openEditVkturiForm();Muxr.editVkturiStatus();');
$q=false;
if(isset($_GET['q'])){
    $q=$_GET['q'];
}
$current = Lang::getCurrent();
$this->title = Uni::t('app', 'Vaccine type');
?>
    <div class="block-process" style="margin-bottom:10px;">
        <div class="uk-grid">
            <div class="uk-width-1-2">
                <a class="md-btn md-btn-success md-btn-small" href="<?=Url::to('settings/vkturi/index')?>"><?=Uni::t('app','All')?></a>
...
$this->registerJs(' /*ko`rish oynasi*/
    $("i.eye").click(function(e){
        ...
        $.get("../vkturi/view",{id: model},function(response){
            if(response!="error"){
