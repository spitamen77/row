...
<div class="block-process" style="margin-bottom:10px;">
    <div class="uk-grid">
        <div class="uk-width-1-2">
            <a class="md-btn md-btn-success md-btn-small" href="<?=Url::to('settings/tuman/index')?>"><?=Uni::t('app','All')?></a>
            ...
            <div class="uk-button-dropdown" data-uk-dropdown="{mode:'click'}">
                ...
                <div class="uk-dropdown">
                    <ul class="uk-nav uk-nav-dropdown">
                        <li><a href="<?=Url::to('settings/tuman/index')?>" class="viloyat"><?= Uni::t('app',"All") ?></a></li>
                        <?php foreach ($items as $item): ?>
                            <li><a href="<?=Url::to('settings/tuman/index?slug=item&region='.$item->id)?>" class="viloyat" data-id="<?=$item->id?>"><?= ($item->name)?$item->name:Uni::t('app',"Not set") ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
            </div>
