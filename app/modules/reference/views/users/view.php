        ...
        <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
            ...
            <div class="user_heading_content">
                <h2 class="heading_b uk-margin-bottom"><span class="uk-text-truncate"><?= $user->lastname ?> <?= $user->username ?></span>
                    <span class="sub-heading" style="font-size: 14px"><?= ($user->roles)?$user->roles->title:"" ?></span></>
                <ul class="user_stats">
                    <li>
                        <h4 class="heading_a"><?=Uni::t('app', 'Created')?> <span class="sub-heading"><?=date("d-m-Y", $user->created)?></span></h4>
                    </li>
                    <li>
                        <h4 class="heading_a"><?=Uni::t('app', 'Last visit')?> <span class="sub-heading"><?=($user->logged==null)? Uni::t('app', 'Not visit'): date("d-m-Y", $user->logged)?></span></h4>
                    </li>
                    ...
                    <div class="uk-grid uk-margin-medium-top uk-margin-large-bottom" data-uk-grid-margin="">
                        ...
                        <div class="uk-width-large-1-2">
                            ...
                            <ul class="md-list">
                                <li>
                                    <div class="md-list-content">
                                        <span class="md-list-heading"><a href="#"><?=($user->roles)?$user->roles->title:""?></a></span>
