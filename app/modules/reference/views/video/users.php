        ...
        <div class="uk-overflow-container">
            <table class="uk-table uk-table-nowrap table_check">
                ...
                <tr>
                    ...
                    <th class="uk-width-1-10 uk-text-center"><?=Uni::t('app','Phone')?></th>
                ...
                <? foreach ($data->models as $model) {?>
                    <tr>
                        ...
                        <td class="uk-text-center">
                            <?if($model->status){?> <span class="uk-badge"><?=Uni::t('app','Active')?></span><?}else{?>
                                <span class="uk-badge uk-badge-danger"><?=Uni::t('app','inActive')?></span>
                            <?}?>
                        </td>
                        <td class="uk-text-center">
