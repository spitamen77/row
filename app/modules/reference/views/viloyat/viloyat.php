                    ...
                    <table class="uk-table uk-table-hover">
                        ...
                        <? foreach ($data->models as $value) : ?>
                            <tr>
                                ...
                                <td><?=$value->summa?></td>
                                <td><?=$value->qoldiq?></td>
                                <td><a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="<?=Url::to("settings/viloyat/tuman/$value->viloyat_id/$value->id")?>"><?=Uni::t('app', 'More')?></a></td>
                            </tr>
                        <? endforeach; ?>
                        </tbody>
                    </table>
                        ...
                        <table class="uk-table uk-table-hover">
                            ...
                            <? foreach ($kutish->models as $value) : ?>
                                <tr>
                                    <td><?=$value->name?></td>
                                    <td><?=$value->kutish?></td>
                                    <td><a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="<?=Url::to("settings/viloyat/viloyat/$value->id/")?>"><?=Uni::t('app', 'More')?></a></td>
                                </tr>
                            <? endforeach; ?>
                            </tbody>
                        </table>
