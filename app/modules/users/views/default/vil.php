        ...
        <div class="uk-width-medium-1-2 uk-row-first">
            ...
            <div class="md-card">
                <div class="md-card-content">
                                    ...
                                    <table class="uk-table uk-table-nowrap uk-table-hover table_check">
                                        ...
                                        <?php foreach (Prixod::getNew() as $item): ?>
                                            <tr>
                                                ...
                                                <td class="uk-text-center"><?=$item->nomer?></td>
                                                <td class="uk-text-center"><?=date('d-m-Y', $item->proxod_date)?></td>
                                                <td class="uk-text-center"><span class="uk-badge uk-badge-primary"><?=Uni::t('app', 'New')?></span></td>
                                    ...
                                    <table class="uk-table uk-table-nowrap uk-table-hover table_check">
                                        ...
                                        <?php foreach (Prixod::getDenied() as $item): ?>
                                            <tr>
                                                ...
                                                <td class="uk-text-center"><?=$item->nomer?></td>
                                                <td class="uk-text-center"><?=date('d-m-Y', $item->proxod_date)?></td>
                                                <td class="uk-text-center"><span class="uk-badge uk-badge-danger"><?=Uni::t('app', 'Denied')?></span></td>
                    ...
                    <a href="<?=Url::to('settings/vkviloyat/prixod')?>" class="md-btn md-btn-wave waves-effect waves-button"><?=Uni::t('app','View all')?></a>
