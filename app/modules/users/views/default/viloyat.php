...
$this->title = $viloyat->$name." | ".Uni::t('app', 'Distribution');
    ...
    <div class="md-card">
        <div class="md-card-content">
            <div class="uk-grid" data-uk-grid-margin="">
                ...
                <div class="uk-width-medium-1-10">
                    <button id="modal_add_VkTuman_btn" data-uk-modal="{bgClose:true;modal:true}" class="md-btn md-btn-facebook uk-margin-small-top" ><?=Uni::t('app','Add')?></button>
                </div>
                <div class="uk-width-medium-7-10">
                    ...
                    <div class="uk-grid" data-uk-grid-margin="">
                        ...
                        <div class="uk-width-medium-3-10">
                            <div class="uk-margin-small-top">
                                <select name="vak_name" data-md-selectize data-md-selectize-bottom>
                                    <option value=""><?=Uni::t('app',"Vaccine name")?></option>
                                    <? foreach ($items as $v) { ?>
                                        <option value="<?=$v->vaksina_id?>"><?=$v->vaksina->name?></option>
                                    <? } ?>
                                </select>
                            </div>
                        </div>
                        <div class="uk-width-medium-2-10">
                            <select name="pri_name" data-md-selectize data-md-selectize-bottom>
                                ...
                                <? foreach ($items as $v) { ?>
                                    <option value="<?=$v->prixod_id?>"><?=$v->prixod->name?></option>
                                <? } ?>
                            </select>
                        </div>
    ...
    <div class="uk-grid">
        <div class="uk-width-2-2">
            <div class="md-card-content">
                ...
                <h2><?=$viloyat->$name." | ".Uni::t('app', 'Last distributions')?></h2>
            </div>
